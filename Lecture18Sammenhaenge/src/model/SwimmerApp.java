...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        for (Swimmer s : swimmers) {
        	training += s.getTrainingPlan().getWeeklyStrengthHours();
        	training += s.getTrainingPlan().getWeeklyWaterHours();
        }
        
        System.out.println("Total weekly training: " + training);
