...
public class VisKatagoriWindow extends Stage {
	...
	private void addBilAction() {
		if(!(cbBiler.getSelectionModel().getSelectedItem().equals(null)) && cbBiler.getSelectionModel().getSelectedItem().getTilstand() == Tilstand.KLAR && !searchBil(cbBiler.getSelectionModel().getSelectedItem(), katagori.getBiler())) {
			katagori.addBil(cbBiler.getSelectionModel().getSelectedItem());
			cbBiler.getSelectionModel().getSelectedItem().setKatagori(katagori);
			lvwBiler.getItems().setAll(katagori.getBiler());
	...
	private void removeBilAction() {
		if(!(lvwBiler.getSelectionModel().getSelectedItem().equals(null))) {
			lvwBiler.getSelectionModel().getSelectedItem().setKatagori(null);
