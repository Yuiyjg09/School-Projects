...
public class AdminPane extends GridPane {
	...
	private void addToVaerksted() {
		if(!lvwBiler.getItems().isEmpty()) {
			...
			alert.setContentText("Ingen Bil at sende på Værksted");
			alert.showAndWait();
		}
	}
	
	private void addToFixed() {
		if(!lvwVaerk.getItems().isEmpty()) {
			...
			alert.setAlertType(AlertType.INFORMATION);
			alert.setHeaderText("Fejl");
			alert.setContentText("Ingen Bil at klargøre");
			alert.showAndWait();
		}
	}
	...
	private void skrotAction() {
		if(!lvwVaerk.getItems().isEmpty()) {
			...
			alert.setAlertType(AlertType.INFORMATION);
			alert.setHeaderText("Fejl");
			alert.setContentText("Ingen Bil at skrotte");
			alert.showAndWait();
		}
	}
