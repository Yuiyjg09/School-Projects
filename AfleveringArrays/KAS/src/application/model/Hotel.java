...
public class Hotel {
	...
	public Hotel(String navn, String adresse, double prisEnkelt, double prisDobbelt, String tlfnr, Person hotelbestyrer) {
		this.setNavn(navn);
	...
	public String toString() {
		return navn + ": " + adresse + ", Pris(Enkelt): " + prisEnkelt + ", pris(Dobbelt): " + prisDobbelt + ", Tlf.Nr.: " + tlfnr;
	}
}
