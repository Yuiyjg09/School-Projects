...
public class Service {
	...
	public static Deltager createDeltager(String navn, String tlfnr, String email, String adresse, String firmaNavn, String firmaTlfnr, String landBy) {
		Deltager deltager = new Deltager(navn, tlfnr, email, adresse, firmaNavn, firmaTlfnr, landBy);
		Storage.addDeltagere(deltager);
		return deltager;
	}
	
	public static void updateDeltager(Deltager deltager, String navn, String tlfnr, String email, String adresse, String firmaNavn, String firmaTlfnr, String landBy) {
	...
	public static Hotel createHotel(String navn, String adresse, double prisEnkelt, double prisDobbelt, String tlfnr, Person hotelbestyrer) {
		Hotel hotel = new Hotel(navn, adresse, prisEnkelt, prisDobbelt, tlfnr, hotelbestyrer);
		Storage.addHoteller(hotel);
		return hotel;
	}
	
	public static void updateHotel(Hotel hotel, String navn, String adresse, double prisEnkelt, double prisDobbelt, String tlfnr, Person hotelbestyrer) {
		hotel.setNavn(navn);
